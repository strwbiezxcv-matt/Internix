...
function bulacanBatch() {
  ...
  const list2 = [
    { company_name: 'Eontech Solutions Inc.', industry: 'IT Services / Software', city: 'Malolos', province: B,
      ...
      source_name: 'Company record - publicly listed Bulacan IT services firm', source_url: null,
      internship_status: NEEDS },
    { company_name: '3S Offshoring and Outsourcing Inc.', industry: 'BPO / Business Services', city: 'San Jose del Monte', province: B,
      description: '3S Offshoring and Outsourcing Inc. - offshoring/outsourcing services company in San Jose del Monte, Bulacan.',
      website: 'https://3s-offshoring.com',
      source_name: 'Official company website (3s-offshoring.com)', source_url: 'https://3s-offshoring.com',
      internship_status: POTENTIAL },
    { company_name: 'ACS Pro Global Corporation', industry: 'BPO / Business Services', city: 'Baliwag', province: B,
      ...
      source_name: 'Official company website (acsproglobal.com)', source_url: 'https://acsproglobal.com',
      internship_status: POTENTIAL },
    ...
    { company_name: 'A. L. Salazar Construction, Inc.', industry: 'Construction', city: 'Malolos', province: B,
      ...
      source_name: 'Official company website (alsci-ph.com)', source_url: 'https://www.alsci-ph.com',
      internship_status: POTENTIAL },
